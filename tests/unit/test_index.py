...
class TestReadIndex:
    ...
    def test_reads_existing_index(self, tmp_path):
        ...
        index_file.write_text(
            json.dumps({"version": 1, "entries": {"test.txt": {"hash": "abc"}}})
        )
    ...
    def test_version_guard_rejects_unknown(self, tmp_path):
        ...
        with pytest.raises(vlfs.VLFSIndexError, match="Unsupported index version"):
...
class TestWriteIndex:
    ...
    def test_roundtrip(self, tmp_path):
        ...
        original = {
            "version": 1,
            "entries": {"path/to/file.txt": {"hash": "def456", "size": 100}},
        }
...
class TestComputeStatus:
    ...
    def test_detects_missing_file(self, repo_root):
        ...
        index = {
            "version": 1,
            "entries": {"missing.txt": {"hash": "abc", "size": 10, "mtime": 12345}},
        }
    ...
    def test_unchanged_file_not_modified(self, repo_root):
        ...
        index = {
            "version": 1,
            "entries": {"test.txt": {"hash": hex_digest, "size": size, "mtime": mtime}},
        }
    ...
    def test_path_separator_normalization(self, repo_root):
        ...
        index = {
            "version": 1,
            "entries": {
                "tools/clang.exe": {"hash": hex_digest, "size": size, "mtime": mtime}
            },
        }
...
class TestStatusCommand:
    ...
    def test_status_shows_missing(self, repo_root, capsys, monkeypatch):
        ...
        index = {
            "version": 1,
            "entries": {"gone.txt": {"hash": "abc", "size": 10, "mtime": 1}},
        }
